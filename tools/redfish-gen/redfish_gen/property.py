...
from .globals import __BASE_PATH__, __RFG_PATH__
    ...
    def _resolve_property_spec(self, spec, global_spec):
        try:
            ...
            if "anyOf" in property_spec:
                ...
                property_spec = property_spec["anyOf"][len(property_spec["anyOf"]) - 1]
...
class OemFragment(Fragments):
    ...
    def __load_spec(self):
        ...
        schema_path = "%s/assets/schemas/bundle/json-schema/%s" % (__RFG_PATH__, filename)
        try:
