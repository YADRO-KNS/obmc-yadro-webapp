...
class Generator:
            ...
            for file in files:
                if file.endswith(".yaml"):
                    ...
                    with open(filename) as f:
                        ...
                        new_parent_tmp[node.instance.def_filename()] = node.instance
    ...
    def generate(self, loader):
        ...
        template = Generator.render(loader, "node.hpp.mako", instance=self.instance, year=year)
    ...
    def generate_all(loader):
        ...
        Generator.__write_metadata_file()
