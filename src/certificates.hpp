...
class CertificateBase : public entity::Collection, public CachedSource
{
  public:
    ...
    ENTITY_DECL_FIELD_DEF(std::vector<std::string>, IssuerAdditionalOrganizationalUnits, {})
    ...
    ENTITY_DECL_FIELD_DEF(std::vector<std::string>, AdditionalOrganizationalUnits, {})
    ...
    class Query : public dbus::FindObjectDBusQuery
    {
      ...
      protected:
                                ...
                                const std::string& fieldNamePrefix = "") const
        {
            ...
            {
                const auto [key, value] = helpers::utils::splitToPair(entry, '=');
