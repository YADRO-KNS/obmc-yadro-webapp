    ...
    public NamedEntity<Accounts>
{
  ...
  protected:
    ...
    ENTITY_DECL_RELATIONS(ENTITY_DEF_RELATION(Roles, Roles::roleDestRelation(fieldUserPrivilege)))
  private:
    DBusQueryPtr query;
};
    ...
    public NamedEntity<DomainGroups>
{
  ...
  protected:
    ENTITY_DECL_QUERY(query)
    ENTITY_DECL_RELATIONS(ENTITY_DEF_RELATION(Roles, Roles::roleDestRelation(fieldPrivilegeId)))
  private:
    DBusQueryPtr query;
};
  ...
  private:
    class Query final : public dbus::FindObjectDBusQuery
    {
        ...
        class FormatType : public query::dbus::IFormatter
        {
          ...
          public:
                                         ...
                                         const DbusVariantType& value) override
            {
                ...
                return formatValueFromDict(types, property, value, Type::unknown);
            }
        };
      ...
      protected:
        ...
        {
            setFieldEnabled(instance, getFieldState(instance) == State::enabled);
        }
    };
