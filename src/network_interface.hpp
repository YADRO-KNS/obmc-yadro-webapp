    ...
    class Query final : public dbus::FindObjectDBusQuery
    {
      ...
      protected:
        DBUS_QUERY_DECLARE_CRITERIA(
            ...
            DBUS_QUERY_CRIT_IFACES(netSysConfigInterfaceName), nextOneDepth,
            networkServiceName)
    };
    ...
    class Query final : public dbus::FindObjectDBusQuery
    {
      ...
      protected:
        DBUS_QUERY_DECLARE_CRITERIA(
            ...
            DBUS_QUERY_CRIT_IFACES(netDHCPConfigInterfaceName), nextOneDepth,
            networkServiceName)
    };
  ...
  private:
    class Query final : public dbus::FindObjectDBusQuery
    {
      ...
      public:
        ...
        DBUS_QUERY_DECL_EP(DBUS_QUERY_EP_IFACES(
            netIpInterfaceName, DBUS_QUERY_EP_FIELDS_ONLY2(fieldAddress),
      ...
      protected:
        DBUS_QUERY_DECLARE_CRITERIA("/xyz/openbmc_project/network",
                                    DBUS_QUERY_CRIT_IFACES(netIpInterfaceName),
                                    noDepth, networkServiceName)
    ...
    public NamedEntity<Ethernet>
{
      ...
      public:
        ...
        DBUS_QUERY_DECL_EP(
            DBUS_QUERY_EP_IFACES(
                netEthInterfaceName, DBUS_QUERY_EP_FIELDS_ONLY2(fieldAutoNeg),
                DBUS_QUERY_EP_SET_FORMATTERS2(
                    fieldDHCPEnabled, DBUS_QUERY_EP_CSTR(FormatDHCPEnabled)),
                ...
                DBUS_QUERY_EP_SET_FORMATTERS2(
                    fieldLinkLocalAutoConf, DBUS_QUERY_EP_CSTR(FormatLinkConf)),
            ...
            DBUS_QUERY_EP_IFACES(netMACInterfaceName,
                                 DBUS_QUERY_EP_FIELDS_ONLY2(fieldMACAddress), ),
            DBUS_QUERY_EP_IFACES(netVLANInterfaceName,
                                 DBUS_QUERY_EP_FIELDS_ONLY("Id", fieldVLANId),
                                 DBUS_QUERY_EP_FIELDS_ONLY("InterfaceName",
                                                           fieldVLANName), ))
      protected:
        DBUS_QUERY_DECLARE_CRITERIA("/xyz/openbmc_project/network",
                                    DBUS_QUERY_CRIT_IFACES(netEthInterfaceName),
                                    nextOneDepth, networkServiceName)
  ...
  protected:
    ...
    ENTITY_DECL_QUERY(query)
    ENTITY_DECL_RELATIONS(ENTITY_DEF_RELATION(IP, relationToIp()),
