        ...
        class FormatExpireAction : public query::dbus::IFormatter
        {
          ...
          public:
                                         ...
                                         const DbusVariantType& value) override
            {
                ...
                // clang-format: on
                return formatValueFromDict(actions, property, value, WatchdogAction::none);
            }
        };
      ...
      public:
        ...
        DBUS_QUERY_DECL_EP(
            DBUS_QUERY_EP_IFACES(
                watchdogIface,
                DBUS_QUERY_EP_FIELDS_ONLY2(fieldEnabled),
                DBUS_QUERY_EP_SET_FORMATTERS2(fieldExpireAction,
                                             DBUS_QUERY_EP_CSTR(FormatExpireAction)
                )
            )
        )
    ...
    class Query : public dbus::GetObjectDBusQuery
    {
      ...
      public:
        ...
        DBUS_QUERY_DECL_EP(
            DBUS_QUERY_EP_IFACES(
                restorePolicyIface,
                DBUS_QUERY_EP_SET_FORMATTERS2(fieldPowerRestorePolicy,
    ...
    public NamedEntity<HostBootProvider>
{
  ...
  public:
    enum class Mode
    {
        diags,
        biosSetup,
        dbusOriginModeMax = biosSetup,  ///< The biosSetup and both other origins from `Mode` dbus interface
