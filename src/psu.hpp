    ...
    public NamedEntity<PMBusProvider>
{
  ...
  private:
    class Query final : public dbus::FindObjectDBusQuery
    {
        ...
        static constexpr const char* psuYadroIface = "com.yadro.Inventory.PSU";
                ...
                if (std::holds_alternative<DBusAssociationsType>(value))
                {
                    ...
                    for (const auto& association : associations)
                    {
                        ...
                        if (purpose == "status")
                        {
                            ...
                            return getNameFromLastSegmentObjectPath(psuObject,
                                                                    false);
                        }
                    }
                }
    ...
    public NamedEntity<PSU>
{
  ...
  protected:
    ...
    ENTITY_DECL_PROVIDERS(
        ...
        ENTITY_PROVIDER_LINK_DEFAULT(StatusByCallbackManager<PSU>)
    )
